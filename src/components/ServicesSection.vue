  ...
  >
    <div class="container">
      <div
        ...
        v-reveal="'fade'"
      >
        <span class="section__label">Что мы предлагаем</span>
        <h2 class="section__title" id="services-title">Услуги клуба ASLAN</h2>
        <p class="section__subtitle">
          Для детей от 6 лет и взрослых любого уровня — от первого урока до
          соревнований.
        </p>
      </div>
      ...
      <div class="services__grid">
        ...
        >
          ...
          <a
            ...
            aria-label="`Записаться на ${svc.name}`"
          >
            Уточнить цену и время
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
...
const services = [
  {
    ...
    tag: "Популярно",
    featured: true,
    icon: `<svg viewBox="0 0 32 32" fill="none" stroke="currentColor" stroke-width="1.8" width="32" height="32">
